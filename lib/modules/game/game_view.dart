...
class _GameViewState extends State<GameView> {
  ...
  Widget _buildHud() {
   return Container(
     ...
     decoration: BoxDecoration(
       color: Colors.black.withOpacity(0.55), // Usé .withOpacity en lugar de .withValues(alpha: 0.55) para evitar errores si no es una función propia de tu AppLayout
           ...
           children: [
             ...
             Expanded(
               child: Obx(() {
                 ...
                 final fuelPercent = controller.fuel.value.clamp(0, controller.maxFuel.value) / controller.maxFuel.value; 
                 Color barColor;
                 if (fuelPercent > 0.6) {
